...
await page.pause();
await page.getByRole('link', { name: 'FX Validity' }).click();
await page.getByRole('link', { name: 'Add FX Validity Template' }).click();
await page.getByLabel('Client Type*').selectOption('100001');
await page.locator('#walletOwner').selectOption('1000009264');
